...
const getEmailFromUsername = require('./email-from-username');
...
module.exports = class KonstructorApiClient {
	...
	constructor(gateway, apiKey) {
		...
		this.userAgent = `konstructor-api-client-node/${pkg.version}`;
	}
	...
	sanitizeChangeRequestCreation(type, data) {
		...
		return Promise.resolve(extend(defaultData, data, sanitizedData));
	}
...
module.exports.getEmailFromUsername = getEmailFromUsername;

const gatewayHostnames = module.exports.gatewayHostnames = {
...
const changeRequestTypes = module.exports.changeRequestTypes = [
	'emergency',
	'fyi',
	'normal',
	'releaselog'
